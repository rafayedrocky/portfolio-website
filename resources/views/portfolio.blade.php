...
<div class="modal fade" id="project2Modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="{{ asset('assets/images/project2.jpg') }}" class="img-fluid mb-4" alt="Fitness App">
...
<div class="modal fade" id="project3Modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <img src="{{ asset('assets/images/project3.jpg') }}" class="img-fluid mb-4" alt="Corporate Website">
