            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="card-text">Robust full-stack apps with Laravel (backend) and Vue.js (frontend) for a seamless user experience.</p>
                        <ul class="list-unstyled text-start">
                            <li><i class="fas fa-check text-primary me-2"></i> RESTful API Development</li>
                            <li><i class="fas fa-check text-primary me-2"></i> Single Page Applications (SPA)</li>
                            <li><i class="fas fa-check text-primary me-2"></i> Real-time Features with Laravel Echo</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="card-text">Clean and secure Laravel backend development, built with performance and scalability in mind.</p>
                        <ul class="list-unstyled text-start">
                            <li><i class="fas fa-check text-primary me-2"></i> Authentication & Authorization</li>
                            <li><i class="fas fa-check text-primary me-2"></i> API Development with Passport/Sanctum</li>
                            <li><i class="fas fa-check text-primary me-2"></i> MySQL/PostgreSQL Database Design</li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body text-center p-4">
                        ...
                        <p class="card-text">Interactive and reactive interfaces using Vue.js and modern UI libraries like Tailwind CSS.</p>
                        <ul class="list-unstyled text-start">
                            <li><i class="fas fa-check text-primary me-2"></i> Reusable Vue Components</li>
                            <li><i class="fas fa-check text-primary me-2"></i> SPA and PWA Development</li>
                            <li><i class="fas fa-check text-primary me-2"></i> Tailwind CSS / Bootstrap Integration</li>
                        </ul>
                    </div>
                </div>
            </div>
